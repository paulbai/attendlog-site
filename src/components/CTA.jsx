        ...
        <div className="inline-block">
          <div className="p-[2px] bg-gradient-to-r from-primary/30 via-primary-container/50 to-primary/30 rounded-full">
            <div className="bg-surface-container-lowest px-10 md:px-14 py-8 md:py-10 rounded-full cyber-shadow-lg">
              <button onClick={onJoinWaitlist} className="group px-10 md:px-14 py-5 md:py-6 rounded-full bg-on-background text-surface font-headline font-bold text-lg md:text-xl hover:scale-105 transition-all duration-300 flex items-center gap-4 mx-auto shadow-[0_8px_40px_rgba(25,28,29,0.2)]">
                Join the waitlist
